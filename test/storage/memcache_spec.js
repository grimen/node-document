  ...
  'Memcache': {
    'new': {
      ...
      '("url")': function() {
        ...
        var storage2 = new Storage('memcache://127.0.0.1:11211/custom');

        assert.equal ( storage2.url, 'memcache://127.0.0.1:11211/custom' );
        assert.typeOf ( storage2.options, 'object' );
        assert.deepEqual ( storage2.options.custom, undefined );
      },
      ...
      '("url", options)': function() {
        ...
        var storage2 = new Storage('memcache://127.0.0.1:11211/custom', {custom: {foo: 'bar'}});
    ...
    '.reset()': function() {
      ...
      Storage.url = "memcache://127.0.0.1:11211/custom";
      assert.equal ( Storage.url, "memcache://127.0.0.1:11211/custom" );
