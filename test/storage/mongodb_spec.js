  ...
  'MongoDB.prototype': {
    ...
    '#get': {
      'one': {
        ...
        '<EXISTING_KEY>': {
          "(<EXISTING_KEY>)  =>  [<VALUE>]default-test', 'set', '": function(done) {
    ...
    '#exists': {
      'one': {
        ...
        '<EXISTING_KEY>': {
          "(<EXISTING_KEY>)  =>  [true]": function(done) {
            native.set('default-test', 'exists', 'existing-one-foo_1-a', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>]': {
          "([<EXISTING_KEY>])  =>  [true]": function(done) {
            native.set('default-test', 'exists', 'existing-one-foo_1-c', {foo: 'bar_1'}, function() {
      ...
      'many': {
        ...
        '[<NEW_KEY>, <EXISTING_KEY>]': {
          "([<NEW_KEY>, <EXISTING_KEY>])  =>  [false, true]": function(done) {
            native.set('default-test', 'exists', 'existing-many-foo_1-b', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>, <NEW_KEY>]': {
          "([<EXISTING_KEY>, <NEW_KEY>])  =>  [true, false]": function(done) {
            native.set('default-test', 'exists', 'existing-many-foo_1-c', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>, <EXISTING_KEY>]': {
          "([<EXISTING_KEY>, <EXISTING_KEY>])  =>  [true, true]": function(done) {
            native.set('default-test', 'exists', 'existing-many-foo_1-d', {foo: 'bar_1'}, function() {
              native.set('default-test', 'exists', 'existing-many-foo_2-d', {foo: 'bar_2'}, function() {
