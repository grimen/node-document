...
var Spec = {
  ...
  'MemoryStorage': {
    ...
    '.klass': function() {
      assert.instanceOf ( storage.klass, require('../../lib/storage/memory') );
    }
  },
      ...
      'one': {
        ...
        '<EXISTING_KEY>': {
          "(<EXISTING_KEY>)  =>  <JSON_VALUE> (REVIEW)": function(done) {
            client.set('default.test/get/existing-one-foo_1-a', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>]': {
          "([<EXISTING_KEY>])  =>  [<JSON_VALUE>]": function(done) {
            client.set('default.test/get/existing-one-foo_1-c', {foo: 'bar_1'}, function() {
      ...
      'many': {
        ...
        '[<NEW_KEY>, <EXISTING_KEY>]': {
          "([<NEW_KEY>, <EXISTING_KEY>])  =>  [null, JSON_VALUE]": function(done) {
            client.set('default.test/get/existing-many-foo_1-b', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>, <NEW_KEY>]': {
          "([<EXISTING_KEY>, <NEW_KEY>])  =>  [JSON_VALUE, null]": function(done) {
            client.set('default.test/get/existing-many-foo_1-c', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>, <EXISTING_KEY>]': {
          "([<EXISTING_KEY>, <EXISTING_KEY>])  =>  [<JSON_VALUE>, <JSON_VALUE>]": function(done) {
            client.set('default.test/get/existing-many-foo_1-d', {foo: 'bar_1'}, function() {
              client.set('default.test/get/existing-many-foo_2-d', {foo: 'bar_2'}, function() {
      ...
      'one': {
        ...
        '<EXISTING_KEY>': {
          "(<EXISTING_KEY>)  =>  [true] (REVIEW)": function(done) {
            client.set('default.test/delete/existing-one-foo_1-b', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>]': {
          "([<EXISTING_KEY>])  =>  [true]": function(done) {
            client.set('default.test/delete/existing-one-foo_1-d', {foo: 'bar_1'}, function() {
      ...
      'many': {
        ...
        '[<NEW_KEY>, <EXISTING_KEY>]': {
          "([<NEW_KEY>, <EXISTING_KEY>])  =>  [false, true]": function(done) {
            client.set('default.test/delete/existing-many-foo_1-b', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>, <NEW_KEY>]': {
          "([<EXISTING_KEY>, <NEW_KEY>])  =>  [true, false]": function(done) {
            client.set('default.test/delete/existing-many-foo_1-c', {foo: 'bar_1'}, function() {
        ...
        '[<EXISTING_KEY>, <EXISTING_KEY>]': {
          "([<EXISTING_KEY>, <EXISTING_KEY>])  =>  [true, true]": function(done) {
            client.set('default.test/delete/existing-many-foo_1-d', {foo: 'bar_1'}, function() {
              client.set('default.test/delete/existing-many-foo_2-d', {foo: 'bar_2'}, function() {
