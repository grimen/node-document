...
var Storage = require('../../lib/storage/filesystem'),
    storage = new Storage(),
  ...
  'FileSystem.prototype': {
    ...
    '#exists': {
      'one': {
        ...
        '<EXISTING_KEY>': {
          "(<EXISTING_KEY>)  =>  [true]": function(done) {
            native.set('/tmp/default-test', 'exists', 'existing-one-foo_1-a', JSON.stringify({foo: 'bar_1'}), function() {
        ...
        '[<EXISTING_KEY>]': {
          "([<EXISTING_KEY>])  =>  [true]": function(done) {
            native.set('/tmp/default-test', 'exists', 'existing-one-foo_1-c', JSON.stringify({foo: 'bar_1'}), function() {
      ...
      'many': {
        ...
        '[<NEW_KEY>, <EXISTING_KEY>]': {
          "([<NEW_KEY>, <EXISTING_KEY>])  =>  [false, true]": function(done) {
            native.set('/tmp/default-test', 'exists', 'existing-many-foo_1-b', JSON.stringify({foo: 'bar_1'}), function() {
        ...
        '[<EXISTING_KEY>, <NEW_KEY>]': {
          "([<EXISTING_KEY>, <NEW_KEY>])  =>  [true, false]": function(done) {
            native.set('/tmp/default-test', 'exists', 'existing-many-foo_1-c', JSON.stringify({foo: 'bar_1'}), function() {
        ...
        '[<EXISTING_KEY>, <EXISTING_KEY>]': {
          "([<EXISTING_KEY>, <EXISTING_KEY>])  =>  [true, true]": function(done) {
            native.set('/tmp/default-test', 'exists', 'existing-many-foo_1-d', JSON.stringify({foo: 'bar_1'}), function() {
              native.set('/tmp/default-test', 'exists', 'existing-many-foo_2-d', JSON.stringify({foo: 'bar_2'}), function() {
