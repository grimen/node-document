...
function Document (type) {
  ...
  schema = args.find(function(arg) { return Object.isObject(arg) && !arg.type === 'storage'; });
  storage = args.find(function(arg) { return arg && arg.type === 'storage'; }); // FIXME: Inherit Storage, to be able to check object class: "object instanceof Storage"
  ...
  klass.storage = storage || new Document.DefaultStorage(); // FIXME: Use "storage instanceof Storage" when implemented.

  // debug("Storage: %s", Class.name(klass.storage));
