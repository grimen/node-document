...
function Model (attributes) {
  ...
  // REVIEW: this.attributes[this.klass.id_attribute] = this.attributes[this.klass.id_attribute] || uuid();
...
Model.set = function(ids, values) {
  ...
  if (!ids_are_valid || !values_are_valid)
    throw new Error("Expected Model.set([id:String, ...], [values:Object, ...], options:Object, callback:Function), got Model.set({args})".assign({args: args}));
...
Model.prototype.save = function() {
  ...
  self.attributes[self.klass.id_attribute] = self.attributes[self.klass.id_attribute] || uuid();
