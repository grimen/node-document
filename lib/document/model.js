...
Model.set = function(ids, values) {
  ...
  var keys = ids.map(function(v) { return [self.type, (v || self.klass.id(self))].join('/'); });
...
Model.prototype.save = function() {
  ...
  self.attributes[self.klass.id_attribute] = self.attributes[self.klass.id_attribute] || self.klass.id(self);
